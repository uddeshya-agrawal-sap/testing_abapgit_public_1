...
CLASS ltc_demo_mul_targets DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      sales_order_items TYPE STANDARD TABLE OF z_cds_v1_1 WITH EMPTY KEY,
...
CLASS ltc_demo_mul_targets IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    environment = cl_cds_test_environment=>create( i_for_entity = 'Z_PV_1' ).
  ENDMETHOD.
...
*
*    "Test
    SELECT * FROM z_pv_1 INTO TABLE @DATA(act_results) ##DB_FEATURE_MODE[VIEWS_WITH_PARAMETERS] .
